...
export type SubscribeNewMessagesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type SubscribeNewMessagesSubscription = (
  { __typename?: 'Subscription' }
  & { messageAdded: (
    { __typename?: 'Message' }
    & ChatMessageFragment
